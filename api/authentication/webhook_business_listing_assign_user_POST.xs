query "webhook/business_listing_assign_user" verb=POST {
      ...
      if ($user != false) {
        ...
        function.run sendgrid_dynamic_send {
          input = {
            ...
            data       : {}|set:"first_name":$user.first_name|set:"listing_name":$business_listing.title|set:"login_link":`$var.base_url|concat:"/business-listings/item?businessid="|concat:$var.business_listing.id:`
          ...
          stack {
            ...
            function.run sendgrid_dynamic_send {
              input = {
                ...
                data       : {}|set:"listing_name":$business_listing1.title|set:"user_email":$new_user.email|set:"signup_link":($base_url|concat:("/auth/forgot-password?user="|concat:$new_user.email:""):"")|set:"first_name":$user.first_name
